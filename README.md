# Recent awesome-shizuku updates

Recent additions and updates to the [awesome-shizuku list](https://github.com/timschneeb/awesome-shizuku). This overview is updated automatically and contains the latest changes, grouped by date. Please note that changes to existing entries are also considered 'new' and get bumped to the top.
